...
#[ApiResource(
    operations: [
        ...
        new GetCollection(),
        new Post(
            security: 'is_granted("PUBLIC_ACCESS")', // AuthenticatedVoter::PUBLIC_ACCESS
            validationContext: ['groups' => ['Default', 'postValidation']], // Default equals to all validations without a group
        ),
